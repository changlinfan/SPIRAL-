function [u, Pprio, r] = ourLocalCover_withDrawStep(u, Pprio, Psec, locationOfUEs, isUEsCovered, maxNumOfUE, config)
    % u: 當前無人機位置，向量形式[x,y]
    % Pprio: 無人機涵蓋的UE
    % Psec: 未被覆蓋的UE

    UAVBSColor = '#daf5e3'; % '#61Cd81';
    UAVBSColor_illegal = '#f5dada'; % '#61Cd81';
